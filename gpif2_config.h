...
#define RESET 0
#define WARM_UP 1
#define T0_DMA_BUSY 3
#define T1_RD_LD 5
#define T0_RD 8
#define T0_RD_LD 2
#define T0_SKIP 4
#define T0_CHECK_DMA 9
#define T1_DMA_BUSY 7
#define T1_CHECK_DMA 11
#define T1_RD 6
#define T1_SKIP 10
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x2E739E01,0x00000100,0xBF800000},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739A02,0x20010004,0x80000080},{0x00000000,0x00000000,0x00000000}},
    {{0x3E739C03,0x00000000,0x80000108},{0x2E739408,0x20000100,0x80000040}},
    {{0x2E739204,0x00000000,0x80000004},{0x00000000,0x00000000,0x00000000}},
    {{0x1E739A09,0x00010004,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x2E739406,0x24000100,0x80000040},{0x3E739C07,0x00000000,0x80000108}},
    {{0x2E73920A,0x00000000,0x80000004},{0x00000000,0x00000000,0x00000000}},
    {{0x2E739A05,0x24000102,0x80000080},{0x00000000,0x00000000,0x00000000}},
    {{0x3E739C03,0x00000000,0x80000108},{0x1E739A02,0x20010004,0x80000080}},
    {{0x2E739A0B,0x04000102,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x2E739A05,0x24000102,0x80000080},{0x3E739C07,0x00000000,0x80000108}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x00007FFC,  /*  CY_U3P_PIB_GPIF_CTRL_COUNT_LIMIT */
    ...
    0x0000C7FE,  /*  CY_U3P_PIB_GPIF_DATA_COUNT_LIMIT */
